...
public final class FunctionRegistry {
  ...
  public static final String VAMLAG_FUNC_NAME = "vamlag";
  public static final String DEDUP_FUNC_NAME = "dedup";
  //public static final String DIFF_FUNC_NAME = "diff";
  ...
  static {
    ...
    system.registerGenericUDF(VAMLAG_FUNC_NAME, VamshiUDFLag.class);
   // system.registerGenericUDF(DEDUP_FUNC_NAME, DedupUDFImp.class);
    ...
    system.registerGenericUDAF("diff", new DiffUDAF());
    ...
    system.registerWindowFunction(VAMLAG_FUNC_NAME, new VamshiUDAFLag());
   // system.registerWindowFunction(DIFF_FUNC_NAME, new DiffUDAF());
   // system.registerWindowFunction(DEDUP_FUNC_NAME, new DedupUDAFImp());
