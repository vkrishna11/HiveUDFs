...
@WindowFunctionDescription
        (
                description = @Description(
                        name = "vamlag",
                        value = "_VAM_FUNC_(expr, amt, default)"
                ),
                supportsWindow = false,
                pivotResult = true,
                impliesOrder = true
        )
public class VamshiUDAFLag extends VamshiUDAFLeadLag {

    static final Log LOG = LogFactory.getLog(VamshiUDAFLag.class.getName());
