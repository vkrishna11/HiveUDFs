 ...
 *
 */
public abstract class VamshiUDAFLeadLag extends AbstractGenericUDAFResolver {
    ...
    public GenericUDAFEvaluator getEvaluator(GenericUDAFParameterInfo parameters)
        ...
        if (paramOIs.length > 1) {
            ...
            if (!ObjectInspectorUtils.isConstantObjectInspector(amtOI)
                ...
                throw new UDFArgumentTypeException(1, fNm + " amount must be a vamshiinteger value "
